...
Model::Model(uint32_t& objectNum, std::vector<Object*>& objects)
	: rotationAngle(0.0f),
	matShining(64.0f),
	id(objectNum++)
{
...
Model::Model(std::string const path, uint32_t& objectNum)
	: rotationAngle(0.0f),
	matShining(64.0f),
	id(objectNum++)
{
...
Model::Model(std::string const path, uint32_t& objectNum, std::vector<Object*>& objects)
	: rotationAngle(0.0f),
	matShining(64.0f),
	id(objectNum++)
{
...
void Model::Draw(Shader* shader, bool customTexture, GLenum drawMode) {
...
void Model::Draw(Shader* shader, GLenum type, unsigned int texId, GLenum drawMode) {
	setTransforms(shader);
	for (int i = 0; i < meshes.size(); i++)
	{
...
void Model::loadCubeMap(std::vector<std::string> faces) {
...
void Model::setTransforms(Shader* shader) {
	shader->use();
